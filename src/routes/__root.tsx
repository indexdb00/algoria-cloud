...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Algoria — AI marketing agents for European brands" },
      { name: "description", content: "Algoria deploys specialized AI agents to manage ad spend, lead generation and brand narrative across European markets. Credit-based, multilingual." },
      { name: "author", content: "Algoria Intelligence AG" },
      { property: "og:title", content: "Algoria — AI marketing agents for European brands" },
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", href: "/__l5e/assets-v1/4c8f32db-855e-4799-8a30-9c5b45488873/algoria-mark.png" },
      { rel: "apple-touch-icon", href: "/__l5e/assets-v1/4c8f32db-855e-4799-8a30-9c5b45488873/algoria-mark.png" },
